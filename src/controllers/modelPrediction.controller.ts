...
import { ModelPredictionRequestDto, ModelPredictionResponseDto } from 'src/dto/modelPrediction.dto';
...
export class ModelPredicitonController {
  constructor(private readonly modelPredictionService: ModelPredictionService) {}
